...
import { getCartTotal } from "@/lib/transactions/shoppingCart";
...
export default function CheckoutPage() {
    ...
    if (!isClient) {
        return <div className="min-h-screen bg-surface px-4 py-12 sm:px-8">Loading...</div>;
    }
    ...
    return (
        <div className="min-h-screen bg-surface px-4 py-12 sm:px-8">
            <div className="max-w-4xl mx-auto">
                <h1 className="text-3xl font-bold mb-8 font-bricolage">Shopping Cart</h1>

                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2 space-y-4">
                        {cart.map((item) => (
                            <div key={item.id} className="flex gap-4 p-4 bg-white rounded-lg border border-outline-variant shadow-sm">
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white p-6 rounded-lg border border-outline-variant shadow-sm sticky top-24">
                            <h2 className="text-xl font-bold mb-4 font-bricolage">Order Summary</h2>
